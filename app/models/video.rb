...
class Video < ApplicationRecord
  ...
  belongs_to :leader, optional: true, counter_cache: :count_of_leaders
  belongs_to :follower, optional: true, counter_cache: :count_of_followers
  belongs_to :song, optional: true, counter_cache: :count_of_songs
  belongs_to :channel, optional: false, counter_cache: :count_of_channels
  belongs_to :event, optional: true, counter_cache: :count_of_events
