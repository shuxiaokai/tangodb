namespace :db do
  task seed_leaders: :environment do
    [
      ...
      "Filipe Lima",
      "Filippo Avignonesi",
      "Flabiano Aldobaraldo",
      "Flaco Dany",
      "Flaqui Figueroa",
      "Francesco Cieschi",
      "Francesco M. Paglionico",
      "Francesco Redavid",
