namespace :db do
  task seed_followers: :environment do
    [
      ...
      "Luna Palacios",
      "Magdalena Gutierrez",
      "Magdalena Gutiérrez",
      "Magdalena Myszka",
      "Maia Castro",
      "Maja Petrovic",
      "Majo Marini",
      "Majo Martirena",
      "Malika Pitou Nicolie",
      "Mamié Sancy",
      "Manuela Rossi",
      "Marcela Guevara",
      "Marcella Monaco",
